	...
	instruction_points: [
		{
			...
			tagline: 'TEMPLATE POST, COPY THIS POST.',
		...
		{
			header: 'Pushing The Wheel Not Good Enough For You? Pull This Lever.',
			tagline: 'On the Right\'s moron \'Learn to Code\' mantra, from someone who works in Development.',
			$published_on_type: 'date',
